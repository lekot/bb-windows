...
const hostDaemonOnlineRpcResponseSuccessSchema = z.discriminatedUnion(
  ...
  [
    ...
    onlineRpcResponseSuccessSchemaFor("host.read_native_claude_history"),
    onlineRpcResponseSuccessSchemaFor("host.read_native_history"),
    onlineRpcResponseSuccessSchemaFor("host.read_native_image"),
    onlineRpcResponseSuccessSchemaFor("host.probe_native_history"),
    onlineRpcResponseSuccessSchemaFor("host.read_zcode_quota"),
    onlineRpcResponseSuccessSchemaFor("host.check_zcode_desktop_registration"),
    onlineRpcResponseSuccessSchemaFor("host.register_zcode_desktop_task"),
